...
KindEditor.plugin('bareheadimage', function(K) {
	var self = this, name = 'bareheadimage',
		...
		uploadJson = this.basePath + 'php/image_upload_watermark.php'),
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<form id="local_image_upload"  method="post" enctype="multipart/form-data" target="' + target + '" action="' + K.addParam(uploadJson, 'dir=image') + '">',
			//file
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
			...
			'<select name="picture_watermark" id="picture_watermark" onchange="changeActionIsWatermark()"><option value="0">&nbsp;&nbsp;不加</option>
			 <option value="1">&nbsp;&nbsp;&nbsp;加</option></select>',
		].join('');
