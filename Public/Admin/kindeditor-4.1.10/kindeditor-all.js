...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<select name="iswater" id="iswater" onchange="changeActionIsWatermark()">',
			...
			'<option value="1">左上角水印</option>',
			'<option value="2">上居中水印</option>',
			'<option value="3" selected>右上角水印</option>',
			'<option value="4">左居中水印</option>',
			'<option value="5">居中水印</option>',
			'<option value="6">右居中水印</option>',
			'<option value="7">左下角水印</option>',
			'<option value="8">下居中水印</option>',
			'<option value="9">右下角水印</option>',
			'</select>',
			'</div>',
			'<div class="ke-dialog-row">',
			'<label style="width:60px;">透明度</label>',
			'<input type="text" name="transparent" class="ke-input-text" value="50" tabindex="-1" style="width:80px;"/> &nbsp;',
			'</div>',
			'</div>',
			'</form>',
			'</div>',
