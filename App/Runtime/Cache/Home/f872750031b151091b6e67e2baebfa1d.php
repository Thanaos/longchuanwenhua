	...
	<div class="hm-zh">
		<form action="#" method="post">
			<ul class="mb30">
                ...
                <li class="mb15" style="height:120px"><strong class="bt">说明：</strong><div id="act_content" style="height: 120px;float:left;font-size: 14px;width: 70%;"><?php echo ($list["0"]["content"]); ?></div></li>
