    ...
    <form action="#" id="registerform">
		<div class="register-form-box">
			<div class="form-item flex">
				<label for="">昵称</label>
                <input type="text" class="form-control flex-item" name="nickname" datatype="*" nullmsg="请输入昵称" errormsg="请输入昵称" value="<?php echo ($userinfo["nickname"]); ?>" placeholder="昵称" />
			</div>
			<div class="form-item flex">
				<label for="">性别</label>
			...
			<div class="form-item flex">
				...
				<select name="education" id="">
                    <?php echo (getOptionEducation($str)); ?>
				</select>
			</div>
		</div>
