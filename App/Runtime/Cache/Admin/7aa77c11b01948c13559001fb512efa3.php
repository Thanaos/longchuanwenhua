...
<div class="form-inline definewidth m20" action="index.html" method="get">
        <button type="button" class="btn btn-success" id="addnew">新增服务点</button>
</div>
...
<script>
    $(".tcdPageCode").createPage({
        ...
        backFn:function(p){
            window.location.href='/index.php/admin/service/branch/'+p+'.html';
        }
    });
    $(function () {
		$('#addnew').click(function(){
            window.location.href="/index.php/admin/service/edit_branch.html";
		 });
