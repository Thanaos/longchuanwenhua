...
<body>
    <div class="form-inline definewidth m20" action="index.html" method="get">
        <button type="button" class="btn btn-success" id="addnew">新建活动</button>
</div>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
             ...
             <td style="width:70px;">
                <a href="/index.php/admin/activity/edit/<?php echo ($vo["id"]); ?>.html">编辑</a>                
...
<script>
    $(".tcdPageCode").createPage({
        ...
        backFn:function(p){
            window.location.href='/index.php/admin/activity/list/'+p+'.html';
        }
    });
    $(function () {
		$('#addnew').click(function(){
            window.location.href="/index.php/admin/activity/edit.html";
		 });
         ...
         $('.del').click(function(){
                ...
                if (r==true)
                {
                    $.post("/index.php/admin/activity/del.html",{id:newsId},function(data){
                        if(data.status == 'y'){
                            alert(data.msg);
