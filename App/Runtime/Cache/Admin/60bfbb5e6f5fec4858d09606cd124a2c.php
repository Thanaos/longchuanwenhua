        ...
        <script>
            $(function(){
                $('#verify').click(function(){
                    $('#img').attr('src','/index.php/admin/user/verify.html');
                })
                $('#but').click(function(){
		...
		<div class="ce-contain" style="background:#42417E;">
			<div class="conter">
				...
				<div class="login-one" style="background-color:rgba(82,81,157,0.8);border:1px solid #8281c7; height:400px;">
                    <form method="post" action="/index.php/admin/user/login.html">
					<table>
						<tr>
							<td  class="one">登录</td>
							<td>
						...
						<tr>
							...
							<img src="/index.php/admin/user/verify.html" id="img" style="width:88px;height:29px;vertical-align: middle"\><span style="font-size: 12px;color:white;margin-left:18px;cursor:pointer" id="verify">换一张</span></td>
							<td></td>
						</tr>
					</table>
