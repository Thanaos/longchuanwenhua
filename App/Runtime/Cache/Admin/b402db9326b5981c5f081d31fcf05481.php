...
<div class="header">
    ...
    <div class="dl-log">欢迎您，<span class="dl-log-user"><?php echo ($admin); ?></span><a href="/zzyl/index.php/admin/user/logout.html"
...
<script>
    BUI.use('common/main', function (){
        var config = [{id:'1',homePage : '2',menu:[{text:'权限管理',items:[
