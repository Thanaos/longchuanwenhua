...
<head>    <link rel="shortcut icon" href="/zzyl/favicon.ico" type="image/x-icon" />
    ...
    <link rel="stylesheet" type="text/css" href="/zzyl/Public/Admin/css/jquery-ui.css" />
    <script type="text/javascript" src="/zzyl/Public/Admin/js/jquery-ui.js"></script>
    <script type="text/javascript" src="/zzyl/Public/Admin/js/jquery-ui-slide.min.js"></script>
    <script type="text/javascript" src="/zzyl/Public/Admin/js/jquery-ui-timepicker-addon.js"></script>
    ...
    <link rel="stylesheet" href="/zzyl/Public/Admin/kindeditor-4.1.10/themes/default/default.css" />
    <script charset="utf-8" src="/zzyl/Public/Admin/kindeditor-4.1.10/kindeditor-all.js"></script>
    <script charset="utf-8" src="/zzyl/Public/Admin/kindeditor-4.1.10/lang/zh_CN.js"></script>
    <script>
        var editor;
        KindEditor.ready(function(K) {
            editor = K.create('textarea[name="content"]', {
                width:'700px',
                height:'400px',
                cssPath : '/zzyl/Public/Admin/kindeditor-4.1.10/plugins/code/prettify.css',
                uploadJson : '/zzyl/index.php/admin/index/uploadImg.html',
                fileManagerJson : '/zzyl/index.php/admin/index/uploadManager.html',
...
<body>
<form action="/zzyl/index.php/admin/service/save.html" id="registerform">
    <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
    <table class="table table-bordered table-hover definewidth m30" >
        <tr>
            <td width="10%" class="tableleft">服务项目<span class="red">*</span></td>
            <td><input type="text" value="<?php echo ($data["service_name"]); ?>" name="service_name" class="inputxt" datatype="*" nullmsg="请输入服务项目！" errormsg="请输入服务项目！" /></td>
        </tr>
        <tr>
            <td width="10%" class="tableleft">服务金额<span class="red">*</span></td>
            <td><input type="text" value="<?php echo ($data["service_price"]); ?>" name="service_price" class="inputxt" datatype="*" nullmsg="请输入服务金额！" errormsg="请输入服务金额！" /></td>
        </tr>
        <tr>
        ...
        $("#registerform").Validform({
            ...
            callback:function(data){
                if(data.status == 'y'){
                    $.Hidemsg();
                    alert(data.msg);
                    window.location.href="/zzyl/index.php/admin/service/list.html";
                }else{
                    alert(data.msg);
                }
                return false;
