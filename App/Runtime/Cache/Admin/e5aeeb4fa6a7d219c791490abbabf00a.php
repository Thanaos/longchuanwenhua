...
<body>
    <form action="/index.php/admin/service/save.html" id="registerform">
        <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
    <table class="table table-bordered table-hover definewidth m10">
        <tr>
            <td width="10%" class="tableleft">服务项目<span class="red">*</span></td>
            <td><input type="text" value="<?php echo ($data["service_name"]); ?>" name="service_name" class="inputxt" datatype="*" nullmsg="请输入服务项目！" errormsg="请输入服务项目！" style="width:500px;" /></td>
        </tr>
        <tr>
            <td width="10%" class="tableleft">服务金额<span class="red">*</span></td>
            <td><input type="text" value="<?php echo ($data["service_price"]); ?>" name="service_price" class="inputxt" datatype="*" nullmsg="请输入服务金额！" errormsg="请输入服务金额！" style="width:500px;" /></td>
        </tr>
        <tr>
	...
	$("#registerform").Validform({
        ...
        callback:function(data){
            if(data.status == 'y'){
                $.Hidemsg();
                alert(data.msg);
                        window.location.href="/index.php/admin/service/list.html";
            }else{
                alert(data.msg);
            }
        return false;
