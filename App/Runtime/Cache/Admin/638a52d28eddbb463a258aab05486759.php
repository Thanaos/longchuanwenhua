        ...
        <script>
            $(function(){
                $('#verify').click(function(){
                    $('#img').attr('src','/zzyl/index.php/admin/users/verify.html');
                })
                $('#but').click(function(){
		...
		<div class="ce-contain" style="background:#42417E;">
			<div class="conter">
				...
				<div class="login-one" style="background-color:rgba(82,81,157,0.8);border:1px solid #8281c7; height:400px;">
                    <form method="post" action="/zzyl/index.php/admin/users/login.html">
					<table>
						<tr>
							<td  class="one">登录</td>
							<td>
						...
						<tr>
							...
							<img src="/zzyl/index.php/admin/users/verify.html" id="img" style="width:130px;height:40px;vertical-align: middle"\><span style="font-size: 12px;color:white;margin-left:18px;cursor:pointer" id="verify">换一张</span></td>
							<td></td>
						</tr>
					</table>
