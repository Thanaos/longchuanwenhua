 ...
 <body>
   ...
   <div class="content">
    <div class="dl-main-nav">
      ...
      <ul id="J_Nav"  class="nav-list ks-clear">
          <li class="nav-item dl-selected"><div class="nav-item-inner nav-home">管理模块</div></li>       
  ...
  <script>
    BUI.use('common/main',function(){
        var config = [{id:'1',homePage : '2',menu:[{text:'系统设置',items:[{id:'2',text:'系统参数',href:'/index.php/admin/option/edit.html'},{id:'2',text:'服务项目',href:'/index.php/admin/service/list.html'},{id:'2',text:'服务点',href:'/index.php/admin/service/branch.html'}]},{text:'订单管理',items:[{id:'2',text:'未处理订单',href:'/index.php/admin/order/untreated.html'},{id:'2',text:'订单查询',href:'/index.php/admin/order/list.html'}]}]}];
