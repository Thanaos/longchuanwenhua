...
<link href="__ROOT__/Public/Home/css/smxc_css.css" rel="stylesheet" />
<link href="__ROOT__/Public/Home/css/style.css" rel="stylesheet" />
</head>
<style>
#sfxz{
  display: block;
...
<img src="__ROOT__/Public/Home/images/back@2x.png" width="48" height="30">
</div>
</div>
...
<span class="keyboard_ok"><img src="__ROOT__/Public/Home/images/keyboard-xiabiao.png"/></span>
</div>
...
<li>K</li>
<li>L</li>
<li id="keyboard_delete" class="keyboard_delete" style="background-color: #b4b6ba;"><img src="__ROOT__/Public/Home/images/keyboard-delete.png"/></li>
<li>Z</li>
<li>X</li>
<li>C</li>
<li>V</li>
...
<script type="text/javascript" src="__ROOT__/Public/Home/js/util.js"></script>
<script type="text/javascript" src="__ROOT__/Public/Home/js/toPinYin.js"></script>
<script type="text/javascript" src="__ROOT__/Public/Home/js/xinghao.js"></script>
<script type="text/javascript" src="__ROOT__/Public/Home/js/cartype.js"></script>
<script type="text/javascript" src="__ROOT__/Public/Home/js/custom.js?v=201411221"></script>
<script type="text/javascript" src="__ROOT__/Public/Home/js/vehicleInspection.js"></script>
    <script src="__ROOT__/Public/Home/js/index.js?v=1.3"></script>
    <!--<script>alert('')</script>-->
</html>
