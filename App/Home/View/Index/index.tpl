...
<link href="__ROOT__/Public/Home/css/mui.min.css" rel="stylesheet" />
<link href="__ROOT__/Public/Home/css/smxc_css.css?num=2" rel="stylesheet" />

<script src="__ROOT__/Public/Home/js/zepto.min.js"></script>

<script src='http://webapi.amap.com/maps?v=1.3&key=1e0db08368f992824dcde5570a837d4f&number=1231231'></script>

<script src='__ROOT__/Public/Home/js/amap.js'></script>
<script src='__ROOT__/Public/Home/js/tool.js'></script>
<!--<script src="__ROOT__/Public/Home/js/ajax_lib.js"></script>-->
...
<!--上门服务 选择块-->
<div class="smfw_icon_taxi"><img id="taxi_img" src="__ROOT__/Public/Home/images/smfw-icon-taxi.png"></div>
...
<div class="smfw_tab_slider"><a href="javascript:;" id="{$vo.id}" class="service"><div class="img"></div><span>{$vo.service_name}<br>{$vo.service_price}元</span></a></div>
</foreach>
</div>
</div>
...
<div id="div_leader" class="leader-icon"><img src="__ROOT__/Public/Home/images/man.png" /></div>
...
<li>4</li>
<li>5</li>
<li style="background-color: #b4b6ba;"><img src="__ROOT__/Public/Home/images/keyboard-delete.png"/></li>
<li>6</li>
<li>7</li>
<li>8</li>
<li>9</li>
...
<script type="text/javascript" src="__ROOT__/Public/Home/js/dialog.js"></script>
<script>
(function(){
...
//loading(true,"__ROOT__/Public/Home/images/loading.gif");
...
if(!carId){
alertNew("请选择车辆",2000,"__ROOT__/Public/Home/images/icon-1.png");
mainObj.loading(false,"");
return ;
}
if(!goods){
mainObj.loading(false,"");
alertNew("请选择产品",2000,"__ROOT__/Public/Home/images/icon-1.png");
return ;
}
...
$.post(url,data,function(data){
    if(data.status == 'y'){
        ...
        alertNew(data.msg,2000,"__ROOT__/Public/Home/images/icon-1.png");
    }
},"json");
});	
...
alertNew("成功支付",2000,"__ROOT__/Public/Home/images/icon-1.png");
}else{
alertNew(res.err_msg,50000,"__ROOT__/Public/Home/images/icon-1.png");
}
});
